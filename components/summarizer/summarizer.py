...
class SummarizeText(object):
    ...
    def predict(self, X, meta):
        if meta and "tags" in meta and "text_tagging_passed" in meta["tags"] and meta["tags"]["text_tagging_passed"]:
                    ...
                    if scores:
                        ...
                        if ranked_sentence:
                            ...
                            if len(summarize_text) >= 2:
                                ...
                                self.result["summarize_text_result"] = str(summarize_text)
                            else:
                                self.result["summarize_text_passed"] = False
                                self.result["failure_reason"] = "Could not summarize text"
